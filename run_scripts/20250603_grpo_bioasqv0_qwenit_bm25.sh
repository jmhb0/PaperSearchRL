...
if [ "$retriever_name" = "e5" ]; then
    index_file=data/pubmed_restricted_jmhb_bioasq_trainv0_n1609_test100_e5/e5_Flat.index
    retriever_path=intfloat/e5-base-v2
elif [ "$retriever_name" = "bm25" ]; then
    index_file=data/pubmed_restricted_jmhb_bioasq_trainv0_n1609_test100_bm25/bm25
    retriever_path=none
fi
